...
namespace Masterv2
{
    public class Tester__Karamba3D_ : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var shapeL = new Rectangle3d(pltL, new Interval(-h / 200, h / 200), new Interval(-b / 200, b / 200));
            ...
            var shapeR = new Rectangle3d(pltR, new Interval(-h / 200, h / 200), new Interval(-b / 200, b / 200));
            ...
            foreach (var truss in trusscrvs)
            {
                ...
                var shape = new Rectangle3d(pl, new Interval(-h / 200, h / 200), new Interval(-b / 200, b / 200));
            ...
            var shapeB = new Rectangle3d(plB, new Interval(-b / 200, b / 200), new Interval(-h / 200, h / 200));
            ...
            DA.SetDataList(1,buckly);
            DA.SetData(2, totalmaxutil);
            DA.SetDataList(3, jointforces);
            DA.SetDataList(4, allBreps);
        }
